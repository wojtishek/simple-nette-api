...
#[OA\Parameter(parameter: 'authEmail', name: 'email', description: 'User email', in: 'query', required: true, schema: new OA\Schema(type: 'string'))]
#[OA\Parameter(parameter: 'authPassword', name: 'password', description: 'User password', in: 'query', required: true, schema: new OA\Schema(type: 'string'))]
#[OA\Parameter(parameter: 'authName', name: 'name', description: 'User name', in: 'query', required: true, schema: new OA\Schema(type: 'string'))]
#[OA\Parameter(parameter: 'authRole', name: 'role', description: 'User role', in: 'query', required: true, schema: new OA\Schema(type: 'string'))]
		...
		responses: [
			new OA\Response(response: '200', description: 'OK', content: new OA\JsonContent(
				properties: [
					...
					properties: [
						new OA\Property(property: 'request', ref: '#/components/schemas/UserDTO', description: 'User data', type: 'object')
					])
				]
			)),
		...
		responses: [
			new OA\Response(response: '200', description: 'OK', content: new OA\JsonContent(
				properties: [
					...
					new OA\Property(property: 'data', description: 'Response data',
						properties: [
							new OA\Property(property: 'token', description: 'JWT token', type: 'string', example: '<KEY>')
						],
						type: 'object'
					)
				],
